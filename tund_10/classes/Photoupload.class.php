...
public function changePhotoSize($width, $height){
	...
	public function resizeImage($image, $ow, $oh, $w, $h){
	...
	$textColor=imagecolorallocatealpha($this->myImage, 255, 255, 255, 40);
	//(mis pilt,r,g,b,0-127)
